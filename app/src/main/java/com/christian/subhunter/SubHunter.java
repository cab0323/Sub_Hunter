package com.christian.subhunter;
//these are all the classes of other peoples
...
public class SubHunter extends Activity {
    ...
    /*
        ...
        This makes it a good place to add the code for the one time set up
        phase.
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initializing the size variables according to screen resolution
    ...
    public boolean onTouchEvent(MotionEvent motionEvent){
        ...
        //setting action to when player removes their finger only
